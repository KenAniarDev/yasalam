...
import {
  ...
  getAllRegisterTransactionsByMonth,
  getAllRegisterTransactionsCurrentDay,
} from '../../utils/firebase';
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (option === 'currentMonth') {
        data = await getAllRegisterTransactionsByMonth(
          moment(new Date()).format('YYYY'),
          moment(new Date()).format('MM')
        );
      } else if (option === 'all') {
        data = await getAllRegisterTransactions();
        ...
        data = await getAllRegisterTransactionsCurrentDay(year, month, day);
      }
      setRegTransactions(
    ...
    <Container>
      <div className='flex justify-between flex-wrap'>
        ...
        <div className='flex flex-wrap'>
          ...
          <CSVLink
            data={CSV}
            filename={'register-transactions.csv'}
