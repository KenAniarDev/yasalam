...
const data = [
   {
      title: "What is a Yasalam Membership?",
      data: "Yasalam is the UAE's luxury lifestyle membership. Yasalam membership will give you unlimited access to enjoy hotels recreational facilities, marine activities, state of the art gyms, sport academies and fitness classes. Also include multiple numbers of Spa and F&B discounts across our venues.",
   },
   {
      title: "How does the Yasalam membership work?",
      data: "Once you are a member, you just need to download the Yasalam app and login to your account.This is how you will explore your benefits, plan your visits, and avail your exclusive member discounts.",
   },
   {
      title: "How do I become a Yasalam Member?",
      data: "If you are looking to join Yasalam, please visit our website and fill in your details and follow the instructions to purchase your membership and activate it. You can also drop us an email to info@Yasalamae.ae or WhatsApp us on +971- 50 000 0000. Someone from our membership team will get in touch with you.",
   },
   {
   ...
   {
      title: "Do I need the Yasalam App?",
      data: "Yes! The Yasalam app is necessary as a member. You will use the app to:",
      list: [
   ...
   },
   {
      ...
      data: "When you reach the check in location at the venue, tap the ‘Yasalam’ button in the app to see your QR code. The venue representative will scan the code and check you in!",
   },
];
