          ...
          <div className='filter-container'>
              ...
              <span className='parent'>
                <div className='dropdown dropdown-down'>
                  <div tabIndex='0' className='dropdown-text'>
                    {currCategory.name} <i className='far fa-angle-down'></i>
                  </div>
            ...
            <div className='filter-option'>
              <span className='parent'>
                <div className='dropdown dropdown-down'>
                  <div tabIndex='0' className='dropdown-text'>
                    {currRegion.name} <i className='far fa-angle-down'></i>
                  </div>
                  <ul tabIndex='0' className='dropdown-content'>
                    <li
                      key={1}
            ...
            <div className='filter-option'>
              <span className='parent'>
                <div className='dropdown dropdown-down'>
                  <div tabIndex='0' className='dropdown-text'>
                    {currFeature.name} <i className='far fa-angle-down'></i>
                  </div>
                  <ul tabIndex='0' className='dropdown-content'>
                    <li
                      key={1}
